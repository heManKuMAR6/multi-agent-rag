...
class AgentState(TypedDict):
    ...
    # Tracks the number of retry iterations for query refinement
    loop_count: int

    # Refined search query generated by Reasoner if context is insufficient
    next_query: str

    # Decision flag set by Reasoner indicating if context is sufficient
